...
#define CTRL "Ctrl"
  ...
  std::vector<ContextMenu::MenuItem> items = {
      ...
      {TYPE_SUBMENU, "", "menu.playback", ICON_FA_PLAY_CIRCLE, "", true, false, {
        ...
        {TYPE_SEPARATOR},
        {TYPE_NORMAL, "frame-step", "menu.playback.next_frame", ICON_FA_ARROW_RIGHT, "RIGHT", playing},
        {TYPE_NORMAL, "frame-back-step", "menu.playback.previous_frame", ICON_FA_ARROW_LEFT, "LEFT", playing},
        ...
        {TYPE_SEPARATOR},
        {TYPE_NORMAL, "add chapter 1", "menu.playback.next_chapter", ICON_FA_FAST_FORWARD, "", chapters.size() > 1},
        {TYPE_NORMAL, "add chapter -1", "menu.playback.previous_chapter", ICON_FA_FAST_BACKWARD, "", chapters.size() > 1},
      ...
      {TYPE_SUBMENU, "", "menu.video", ICON_FA_VIDEO, "", true, false, {
        ...
        {TYPE_SUBMENU, "", "menu.video.aspect_ratio", "", "", true, false, {
          {TYPE_NORMAL, "set video-aspect 16:9", "16:9"},
          {TYPE_NORMAL, "set video-aspect 16:10", "16:10"},
          {TYPE_NORMAL, "set video-aspect 4:3", "4:3"},
          {TYPE_NORMAL, "set video-aspect 2.35:1", "2.35:1"},
          {TYPE_NORMAL, "set video-aspect 1.85:1", "1.85:1"},
          {TYPE_NORMAL, "set video-aspect 1:1", "1:1"},
          {TYPE_NORMAL, "set video-aspect -1", "menu.video.aspect_ratio.reset"},
        }},
      ...
      {TYPE_SUBMENU, "", "menu.help", ICON_FA_QUESTION_CIRCLE, "", true, false, {
        {TYPE_NORMAL, "script-message-to implay about", "menu.help.about", ICON_FA_INFO_CIRCLE},
        {TYPE_NORMAL, "script-message-to implay settings", "menu.help.settings", ICON_FA_COG},
      }},
      {TYPE_SEPARATOR},
